...
SERVER_AUTH_NOT_FOUND = 'SERVER_AUTH_NOT_FOUND'
SERVER_AUTH_NOT_VALID = 'SERVER_AUTH_NOT_VALID'
...
# user
ERROR_USERNAME_IS_EXIST = 'ERROR_USERNAME_IS_EXIST'

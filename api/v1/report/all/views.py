            ...
            if len(res) > 0:
                ...
                for data in data_cursor:
                    ...
                    val = {
                        ...
                        'DIEM_TANG_TRUONG_HDVON_BQ_KKH': lib.parseString(data[8]),
                        'HTKH_LK_TANG_TRUONG_CHOVAY': lib.parseString(data[9]),
                        'DIEM_TANG_TRUONG_CHOVAY': lib.parseString(data[10]),
                        'HTKH_LK_TANG_TRUONG_CHOVAY_BQ': lib.parseString(data[11]),
                        'DIEM_TANG_TRUONG_CHOVAY_BQ': lib.parseString(data[12]),
                        'HTKH_LK_THU_PHI_DICH_VU': lib.parseString(data[13]),
                        'DIEM_THU_PHI_DICH_VU': lib.parseString(data[14]),
                        'HTKH_LK_THUPHI_TTQT_LNKDNH': lib.parseString(data[15]),
                        'DIEM_THUPHI_TTQT_LNKDNH': lib.parseString(data[16]),
                        'HTKH_LK_DOANHSO_THANHTOAN_QR': lib.parseString(data[17]),
                        'DIEM_DOANHSO_THANHTOAN_QR': lib.parseString(data[18]),
                        'HTKH_LK_MERCHANT_QR': lib.parseString(data[19]),
                        'DIEM_MERCHANT_QR': lib.parseString(data[20]),
                        'HTKH_LK_DOANHSO_THANHTOAN_POS': lib.parseString(data[21]),
                        'DIEM_DOANHSO_THANHTOAN_POS': lib.parseString(data[22]),
                        'HTKH_LK_LOI_NHUAN_TRUOC_THUE': lib.parseString(data[23]),
                        'DIEM_LOI_NHUAN_TRUOC_THUE': lib.parseString(data[24]),
                        'HTKH_LK_SLKH_MOI': lib.parseString(data[25]),
                        'DIEM_SLKH_MOI': lib.parseString(data[26]),
                        'HTKH_LK_SLHD_EBANKING': lib.parseString(data[27]),
                        'DIEM_SLHD_EBANKING': lib.parseString(data[28]),
                        'HTKH_LK_KHMOI_SPVAYTIEN': lib.parseString(data[29]),
                        'DIEM_KHMOI_SPVAYTIEN': lib.parseString(data[30]),
                        'HTKH_LK_DOANHSO_BAOLANH': lib.parseString(data[31]),
                        'DIEM_DOANHSO_BAOLANH': lib.parseString(data[32]),
                        'DIEM_CHITIEU_CHATLUONG_DICHVU': lib.parseString(data[33]),
                        'DIEM_CHITIEU_QLRR': lib.parseString(data[34]),
                        'DIEM_CBNV_NGHI_VIEC': lib.parseString(data[35]),
                        'DIEM_TYLE_NO2_PHATSINH': lib.parseString(data[36]),
                        'DIEM_TYLE_NOXAU_PHATSINH': lib.parseString(data[37]),
                        'HTKH_LK_XULY_NOXAU_THONGTHUONG': lib.parseString(data[38]),
                        'DIEM_XULY_NOXAU_THONGTHUONG': lib.parseString(data[39]),
                        'DIEM_KHUYEN_KHICH': lib.parseString(data[40]),
                        'TONG_DIEM': lib.parseString(data[41]),
                        'DIEU_CHINHG_TONG_DIEM': lib.parseString(data[42]),
                        'TONG_DIEM_SAU_DIEU_CHINH': lib.parseString(data[43]),
                        'XEP_HANG': lib.parseString(data[44]),
                        'XEP_LOAI': lib.parseString(data[45]),
                        'STATUS': data[46],
